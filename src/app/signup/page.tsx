...
import { AlertCircle, Check, Eye, EyeOff, ArrowRight, Info, User, Mail, Lock, Calendar, Users, Layers, Trophy, Heart, Zap } from 'lucide-react'
        ...
        <div className="signup-form-wrap">
          ...
          <div className="signup-social-row">
            <button
              type="button"
              disabled={true}
              aria-label="Continue with Google. Google signup is coming soon."
              title="Google signup is coming soon"
